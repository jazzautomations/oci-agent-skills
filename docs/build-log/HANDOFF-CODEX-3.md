# HANDOFF 3 → Codex — Wave 2 batch C: 11 skills (infra + delivery)
...
oci-compute, oci-networking, oci-object-storage, oci-block-file-storage, oci-bastion-access, oci-oke,
oci-devops-pipelines, oci-serverless, oci-terraform, oci-vault-certificates, oci-monitoring-alarms
