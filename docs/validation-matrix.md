...
| V14 | `uv run --frozen --project runtime pytest -q tests skills/oci-incident-triage/tests skills/oci-security-posture/tests skills/oci-sdk-patterns/tests` | PASS | 2026-09-10 | 450 tests passed in the full suite after the Classic scope repair. Temporary runtime dependencies used UV_LINK_MODE=symlink; distributed payload checks still require copies without symlinks. |
