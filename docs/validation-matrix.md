...
| V18 | `CLI_PYTHON scripts/check_examples.py --report docs/evidence/validation-examples-offline.json` | PASS | 2026-09-11 | 269 examples passed offline after the shape-only VCN placeholder repair; see docs/evidence/task-repair-final-checks-2026-09-11.json. No new live authorization. |
